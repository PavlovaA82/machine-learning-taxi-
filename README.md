...
:warning: Основной файл реализации доступен по ссылке `ТЫК`:  
...
## :floppy_disk: Пример Использования
...
## :arrow_down_small: На скриншоте показаны результаты работы модели прогнозирования стоимости поездок такси.  

После генерации 10 000 синтетических записей и предобработки данных были обучены три модели: `Random Forest, Gradient Boosting и Linear Regression.`  

Лучшие результаты показала модель `Gradient Boosting с метриками MAE = 139.02, RMSE = 248.96 и R² = 0.951`, что свидетельствует о высокой точности предсказаний.

<img width="1239" height="469" alt="image" src="https://github.com/user-attachments/assets/26672279-8562-4958-a676-01ed02577403" />

## :arrow_down_small: На изображении представлена таблица важности факторов, влияющих на стоимость поездки. 

Наиболее значимыми признаками стали `surge_multiplier, distance_km и vehicle_type`, которые вносят наибольший вклад в предсказание модели.

Остальные параметры, такие как погодные условия или уровень трафика, оказали сравнительно меньший эффект.

<img width="697" height="409" alt="image" src="https://github.com/user-attachments/assets/8203c6d2-5023-4c7e-bf3f-cae74a1b51d2" />

## :arrow_down_small: На изображении представлены результаты визуализации работы модели `Gradient Boosting`.  

В верхней части показаны важнейшие факторы, влияющие на цену поездки, и сравнение метрик трёх моделей: `Random Forest, Gradient Boosting и Linear Regression.`  
